...
def get_data(symbol = 'BTC/USDT', timeframe='1d', limit=180):
...
def update(country = 'US', ticker = "BTC-USDT"):
    ...
    #end_date = None
    train_samples = 69 #max ~180 samples
    data = get_data()
    ...
    today = get_data(limit=100)
    
    today.columns = ['Date', 'Close', 'High', 'Low', 'Open', 'Volume']
